...
@dataclass
class Config:
    experiment_name = 'experiment_2_38'
    experiment_description = """This is experiment 2. Run 38. 50 hidden units. Without Smolensky propagation. Support for distributions of 3. Unclamped unlearn."""
