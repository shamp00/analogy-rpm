...
@dataclass
class Config:
    experiment_name = 'experiment_2_31'
    experiment_description = """This is experiment 2. Run 31. 0 hidden units. Without Smolensky propagation. Support for distributions of 3."""
