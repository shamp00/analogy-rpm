...
@dataclass
class Config:
    experiment_name = 'experiment_2_54'
    experiment_description = """This is experiment 2. Run 54. 50 hidden units. Input and transformation set, but unclamped unlearn. Eta back to 0.0003."""
