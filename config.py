...
@dataclass
class Config:
    experiment_name = 'experiment_1_23'
    experiment_description = """This is experiment 1. Run 23. 10 hidden units. With support for diagonals and voting."""
...
# @dataclass
# class Config:
#     experiment_name = 'experiment_2_35'
#     experiment_description = """This is experiment 2. Run 35. 7 hidden units. Without Smolensky propagation. Support for distributions of 3."""
