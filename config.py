...
@dataclass
class Config:
    experiment_name = 'experiment_2_39'
    experiment_description = """This is experiment 2. Run 39. 7 hidden units. Without Smolensky propagation. Support for distributions of 3. Unclamped unlearn."""
