...
@dataclass
class Config:
    experiment_name = 'experiment_2_33'
    experiment_description = """This is experiment 2. Run 33. 30 hidden units. Without Smolensky propagation. Support for distributions of 3."""
