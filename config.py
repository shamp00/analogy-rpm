...
@dataclass
class Config:
    experiment_name = 'experiment_2_36'
    experiment_description = """This is experiment 2. Run 36. 14 hidden units. Without Smolensky propagation. Support for distributions of 3. Unclamped unlearn."""
