...
@dataclass
class Config:
    experiment_name = 'experiment_1_16'
    experiment_description = """This is experiment 1. Run 16. 50 Hidden units. Ensuring nothing has changed since improvements to matrix generation."""
