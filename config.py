...
@dataclass
class Config:
    experiment_name = 'experiment_2_32'
    experiment_description = """This is experiment 2. Run 32. 14 hidden units. Without Smolensky propagation. Support for distributions of 3."""
